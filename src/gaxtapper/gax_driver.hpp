...
class GaxDriver {
 public:
  static constexpr agbsize_t kMyWorkRamOffset = 0xcc;

  static constexpr agbsize_t kGax2EstimateOffset = 0x1e4;
  static constexpr agbsize_t kGax2NewOffset = 0x1ec;
  static constexpr agbsize_t kGax2InitOffset = 0x1f4;
  static constexpr agbsize_t kGaxIrqOffset = 0x1fc;
  static constexpr agbsize_t kGaxPlayOffset = 0x204;
 ...
 private:
  static constexpr unsigned char gsf_driver_block[0x208] = {
      ...
      0x0B, 0x48, 0x00, 0xF0, 0x1F, 0xF8, 0x02, 0xDF, 0xFD, 0xE7, 0x00, 0x00,
